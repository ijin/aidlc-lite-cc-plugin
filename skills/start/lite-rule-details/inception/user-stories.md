...
Ask 3-5 high-impact questions using the `AskUserQuestion` tool covering the most relevant categories for this project. Categories to consider: User Personas, Story Granularity, Acceptance Criteria, User Journeys, Business Context.

- Wait for user to provide answers
- If critical ambiguity remains, ask up to 2 targeted follow-ups using `AskUserQuestion`. Then proceed.
- After collecting answers, create `aidlc-docs/inception/user-stories/questions-summary.md` to record the Q&A for audit trail
